...
def whale(accounts):
    ...
    whale = accounts.at("0x289c23Cd7cACAFD4bFee6344EF376FA14f1bF42D", force=True)
    yield whale
...
@pytest.fixture(scope="module")
def strategy_name():
    strategy_name = "StrategyConvexFraxFXS"
    yield strategy_name
...
# manual entry of pool address since FXS is not yet in registry
@pytest.fixture(scope="module")
def fxslp_address():
    fxslp_address = "0xF3A43307DcAFa93275993862Aae628fCB50dC768"
    yield fxslp_address
...
def strategy(
    ...
    strategy.setHarvestProfitNeeded(80000e6, {"from": gov})
